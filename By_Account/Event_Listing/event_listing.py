...
#Event Listing
outfile = 'D:/on24/ON24_py/By_Account/Event_Listing/'

col_csv = outfile+'event_column_list.csv'
...
if not df_final.empty:
    df_final.fillna('null').to_csv(outfile+'event_listing_by_account_jan_aug_2020_1.csv', sep=',',encoding='utf-8',mode='a',index=False)