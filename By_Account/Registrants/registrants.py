...
#Registrants
outfile = 'D:/on24/ON24_py/By_Account/Registrants/'
...
if not df_final.empty:
    df_final.fillna('null').to_csv(outfile+'registrants_by_account_jan_aug_2020.csv', sep=',',encoding='utf-8',mode='a',index=False)